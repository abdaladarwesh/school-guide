...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  ...
  head: () => ({
    meta: [
      ...
      { title: "School Guide — Applied Technology Schools in Egypt" },
      {
        name: "description",
        content:
          "Discover Egypt's 32 Applied Technology Schools: specializations, industry partners, careers and admissions.",
      },
